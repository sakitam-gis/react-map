...
const page1Data = [
  {
    img: require('../../../assets/images/example.svg'),
    name: '示例',
    nameEn: '示例',
    to: '/examples/index/',
    svgBg: (
  ...
  {
    img: require('../../../assets/images/start.svg'),
    name: '起步',
    nameEn: 'start',
  ...
  {
    img: require('../../../assets/images/docs.svg'),
    name: '文档',
    nameEn: 'api',
    to: '/docs/api/map',
    svgBg: (
  ...
  {
    img: require('../../../assets/images/res.svg'),
    name: '资源',
    nameEn: 'res',
...
class Introduce extends React.PureComponent {
  ...
  render() {
    const { isMobile, themeConfig } = this.props;
